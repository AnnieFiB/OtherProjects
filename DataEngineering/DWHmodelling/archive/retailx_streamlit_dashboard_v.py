...
def get_connection():
    return psycopg2.connect(
        dbname=os.getenv("SALES_DB_NAME", st.secrets["SALES_DB_NAME"]),
        user=os.getenv("SALES_DB_USER", st.secrets["SALES_DB_USER"]),
        password=os.getenv("SALES_DB_PASSWORD", st.secrets["SALES_DB_PASSWORD"]),
        host=os.getenv("SALES_DB_HOST", st.secrets["SALES_DB_HOST"]),
        port=os.getenv("SALES_DB_PORT", st.secrets["SALES_DB_PORT"])
    )
