    ...
    "data_sources": {
        "zulo_bank": {
            ...
            "oltp": {
                ...
                "keys": ["transaction_id", "Cucustomer_id","loan_id", "account_id"],
                "contact_columns": {'email_col': 'Email', 'phone_col': 'Phone'},
                "derived_fields": {"price_col": "InterestRate", "qty_col": "LoanAmount", "new_col": "interest"},
                "date_mapping": {
                ...
                "table_mapping": {
                       ...
                       "loans": ["loan_id", "customer_id", "loan_amount", "loan_type","start_date", "end_date", "interest"],
            ...
            "olap": {
                ...
                "dimensions": {
                    ...
                    "dim_loans": ["loan_id", "loan_type", "interest_rate"],
                    "dim_transactions": ["transaction_id", "transaction_type"]
                },
                "facts": {
                    "fact_transactions": ["transaction_id", "account_id", "opening_date_id", "transaction_date_id", "amount"],
                    "fact_loans": ["loan_id", "customer_id", "start_date_id", "end_date_id", "loan_amount", "interest"]
                }
